  ...
  return (
    <>
      ...
      <section className={styles.privacy}>
        <h1>Datenschutz</h1>
        <p>
          Datenschutz ist uns als Studiengang sehr wichtig. Deswegen haben wir
          die komplette Webseite von Grund aus darauf ausgelegt, dass keine
          Cookies gespeichert werden. Der Stream über vimeo und die eingebetten
          Videolinks sind nicht 100% in unserer Hand. Hier leiten wir Ihren
          Aufruf so anonym wie uns möglich ist weiter, können aber deren
          Transparenz in Hinsicht auf Datenschutz nicht gewährleisten.
        </p>
        <p>
        ...
        <p>
          IMD-F &ndash; Interactive Media Design Förderverein e.V. c/o
          Hochschule Darmstadt University of Applied Sciences Mediencampus
          Max-Planck-Strasse 2 64807 Dieburg Telefon: +49-6151-16-39450 E-Mail:
          info@imd-f.de
        </p>
        <p>
